            ...
            String htmlContent = """
                ...
                <head>
                    ...
                    <style>
                        ...
                        .checklist-item { font-size: 12.5px; color: #701a75; font-weight: 600; margin: 4px 0; }
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <p style="margin: 0 0 12px 0;">
                                    This is an official notice sent <strong>1 day before</strong> your project submission deadline. The assigned project deliverable deadline is <strong>tomorrow (%s)</strong>.
                                </p>

                                <div class="highlight-notice">
                                    <strong>📌 Submission Requirement:</strong> Without fail, please ensure all task-related source code files, project folders, GitHub/GitLab repositories, and documentation are uploaded and submitted before tomorrow's deadline (<strong>%s</strong>).
                                </div>

                                <!-- Task Deliverables Card -->
                                <div class="task-box">
                                    <div class="badges-row">
                                        <span class="badge-priority">%s Priority</span>
                                        <span class="badge-deadline">Due: Tomorrow (%s)</span>
                                    </div>
                                    <div class="task-name">📌 %s</div>
                                    <div class="task-desc-box">%s</div>
                                    <div class="task-meta">Assigned Intern: <strong>@%s</strong></div>
                                </div>
                ...
                """.formatted(
                    ...
                    deadline != null ? deadline : "Tomorrow",
                    taskTitle,
                    description != null && !description.isBlank() ? description : "Complete the assigned project deliverables and submit the repository or files through your intern portal.",
                    username,
                    username
                );
